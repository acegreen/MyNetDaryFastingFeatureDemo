...
// credits: https://gist.github.com/mecid/f8859ea4bdbd02cf5d440d58e936faec
                    ...
                    VStack {
                        Button(action: { selectedDate = date }) {
                            Text(dayFormatter.string(from: date))
                                .padding(8)
                                .foregroundColor(calendar.isDateInToday(date) ? Color.white : calendar.isDate(date, inSameDayAs: selectedDate) ? .white : .primary)
                                .background(
